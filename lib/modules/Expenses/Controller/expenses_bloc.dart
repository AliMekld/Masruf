...
class ExpensesBloc extends Bloc<ExpensesEvents, ExpensesState> {
  ...
  Future<void> _onLoadExpenses(
    ...
    final result = await _repo.getExpensesFromLocalDataBase();
    result.fold(
      (l) => emit(state.copyWith(isLoading: false, errorMessage: l.model.message)),
      (r) => emit(state.copyWith(isLoading: false, expensesList: r)),
    );
  }
  ...
  Future<void> _onInsertExpense(
    ...
    result.fold(
      ...
      (r) {
        ...
        emit(state.copyWith(isLoading: false, expensesList: newList));
      },
    );
  }
